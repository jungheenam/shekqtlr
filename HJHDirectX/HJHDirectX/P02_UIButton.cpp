...
HRESULT P02_UIButton::Init( BOOL _callback , VEC3 _postion , VEC2 _size , VEC2 _scale , CALLBACK_FUNTION _void )
{

	cb = _callback;
	if ( cb ) callback = static_cast< CALLBACK_FUNTION >( _void );
	TEXTUREM->Add( _T( "normal" ) , _T( "Texture/p02_ui/mainButton01.png " ) , D3DX_FILTER_NONE );
	TEXTUREM->Add( _T( "over" ) , _T( "Texture/p02_ui/mainButton01.png " ) , D3DX_FILTER_NONE );
	TEXTUREM->Add( _T( "down" ) , _T( "Texture/p02_ui/mainButton02.png " ) , D3DX_FILTER_NONE );
